...
|---|---|---|
| a test harness | aggregator with no assertion-count floor (QUM-1029 — **fixed for the shared e2e aggregator only**: every row under `scripts/e2e-tests/` now declares `MIN_ASSERTIONS`, see /e2e-matrix. QUM-1044 co-cited the same class; other harnesses still have no floor) | `0 passed / 0 failed`, exit 0 |
