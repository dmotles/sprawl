...
- Do NOT use the CLI's built-in SendMessage or ListAgents tools — they are a cross-session registry, not sprawl agents, and are denied to you; {{PARENT_NAME}} never appearing in ListAgents does NOT mean {{PARENT_NAME}} is gone. If you ever conclude {{PARENT_NAME}} is unreachable, you are BLOCKED: escalate and retry send_message, never end your turn with the result stranded only in this transcript.
