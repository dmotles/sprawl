...
func TestAgentLiveness_String(t *testing.T) {
	...
	stateCases := []struct {
		...
		{"running_autonomous", State{Liveness: Running, InAutonomousTurn: true}, "running·autonomous-turn"},
		{"running_plain", State{Liveness: Running, InAutonomousTurn: false}, "running"},
	}
...
func TestCanTransition_Legal(t *testing.T) {
	cases := []struct {
		...
		{"T4_running_to_autonomous", State{Liveness: Running, InAutonomousTurn: false}, State{Liveness: Running, InAutonomousTurn: true}},
		{"T5_autonomous_to_running", State{Liveness: Running, InAutonomousTurn: true}, State{Liveness: Running, InAutonomousTurn: false}},
		{"T6a_running_to_faulted", State{Liveness: Running, InAutonomousTurn: false}, State{Liveness: Faulted}},
		{"T6b_autonomous_to_faulted", State{Liveness: Running, InAutonomousTurn: true}, State{Liveness: Faulted}},
		{"T7_running_to_stopping", State{Liveness: Running, InAutonomousTurn: false}, State{Liveness: Stopping}},
		...
		{"T10_recovering_to_running", State{Liveness: Recovering}, State{Liveness: Running, InAutonomousTurn: false}},
		{"T11_recovering_to_faulted", State{Liveness: Recovering}, State{Liveness: Faulted}},
		{"T12_running_to_suspended", State{Liveness: Running, InAutonomousTurn: false}, State{Liveness: Suspended}},
		...
		{"T14_resuming_to_running", State{Liveness: Resuming}, State{Liveness: Running, InAutonomousTurn: false}},
		{"T15_resuming_to_resumefailed", State{Liveness: Resuming}, State{Liveness: ResumeFailed}},
		{"T16_running_to_killed", State{Liveness: Running, InAutonomousTurn: false}, State{Liveness: Killed}},
		...
		{"T17_running_to_retiring", State{Liveness: Running, InAutonomousTurn: false}, State{Liveness: Retiring}},
...
func TestCanTransition_Illegal(t *testing.T) {
	cases := []struct {
		...
		{"inv4_autonomousturn_not_sink", State{Liveness: Running, InAutonomousTurn: true}, State{Liveness: Stopping}},
		{"t12_unstarted_to_suspended_illegal", State{Liveness: Unstarted}, State{Liveness: Suspended}},
		{"running_noop_same_substate", State{Liveness: Running, InAutonomousTurn: false}, State{Liveness: Running, InAutonomousTurn: false}},
		{"bad_bit_on_nonrunning", State{Liveness: Running, InAutonomousTurn: false}, State{Liveness: Faulted, InAutonomousTurn: true}},
		{"stopped_to_running_direct", State{Liveness: Stopped}, State{Liveness: Running}},
		{"inv4_autonomousturn_to_killed", State{Liveness: Running, InAutonomousTurn: true}, State{Liveness: Killed}},
		{"inv4_autonomousturn_to_retiring", State{Liveness: Running, InAutonomousTurn: true}, State{Liveness: Retiring}},
...
func TestFrom_MapsFromToday(t *testing.T) {
	cases := []struct {
		...
		{"running_idle", Snapshot{Lifecycle: "started", RuntimeState: "idle"}, State{Liveness: Running, InAutonomousTurn: false}},
		{"running_autonomous_via_turnactive", Snapshot{Lifecycle: "started", RuntimeState: "turn-active"}, State{Liveness: Running, InAutonomousTurn: true}},
		{"running_autonomous_via_bool", Snapshot{Lifecycle: "started", RuntimeState: "idle", InAutonomousTurn: true}, State{Liveness: Running, InAutonomousTurn: true}},
...
func TestFrom_Precedence(t *testing.T) {
	cases := []struct {
		...
		{"done_ignored_falls_through", Snapshot{Lifecycle: "started", RuntimeState: "idle", DiskStatus: "done"}, State{Liveness: Running, InAutonomousTurn: false}},
...
func TestFrom_NeverYieldsTransients(t *testing.T) {
	snaps := []Snapshot{
		...
		{Lifecycle: "started", RuntimeState: "idle", InAutonomousTurn: true},
...
func TestProcessAlive(t *testing.T) {
	cases := []struct {
		...
		{"running_autonomous", State{Liveness: Running, InAutonomousTurn: true}, true},
...
func TestStatus_Projection(t *testing.T) {
	cases := []struct {
		...
		{"running_autonomous", State{Liveness: Running, InAutonomousTurn: true}, "active"},
