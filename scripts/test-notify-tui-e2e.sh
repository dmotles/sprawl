...
#
# It asserted on both .last_report_* fields and the deleted status_change envelope class.
echo "SKIP: ${0##*/} is superseded by matrix row 'notify-tui' — its coverage lives there now." >&2
echo "  Run instead:  make test-e2e-matrix-notify-tui" >&2
