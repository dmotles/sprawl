...
#
# Its probe prompts instructed the woken child to call report_status.
echo "SKIP: ${0##*/} is superseded by matrix row 'wake-live' — its coverage lives there now." >&2
echo "  Run instead:  make test-e2e-matrix-wake-live" >&2
