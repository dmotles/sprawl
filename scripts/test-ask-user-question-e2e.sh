...
#
# Its phases 0/1/2 all polled .last_report_message for the selected option label.
echo "SKIP: ${0##*/} is superseded by matrix row 'ask-user-question' — its coverage lives there now." >&2
echo "  Run instead:  make test-e2e-matrix-ask-user-question" >&2
